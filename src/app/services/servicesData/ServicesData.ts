...
import { Electrical, Mechanical, Automation, Commissioning, Energy, Projects, Communication, Lighting, LowVoltage, PowerDistribution, PowerQuality, Wireline, FireProtection, HVAC, Piping, Plumbing, ControlsSystem, ElectricalWiring, Telemetry, BuildingSystems, LEED, Building, Metro, Metro2, School, Solar, Theater } from '../ServicesAssets/ServicesAssetImports'
...
export const services: Service[] = [
  ...
  },
  {
    ...
    img: Mechanical,
    title: "Mechanical",
    description: "Comprehensive mechanical engineering services",
    subCategories: [
      {
  ...
  },
  {
    ...
    img: Automation,
    title: "Automation",
    description: "Comprehensive automation engineering services",
    subCategories: [
      {
  ...
  },
  {
    ...
    img: Commissioning,
    title: "Commissioning",
    description: "Comprehensive commissioning engineering services",
    subCategories: [
      {
  ...
  },
  {
    ...
    description: "Comprehensive energy engineering services",
    subCategories: [
      {
        image: Theater,
  ...
  },
  {
    ...
    img: Projects,
    title: "Projects",
    description: "Comprehensive project engineering services",
    subCategories: [
      {
        subtitle: "Fire Protection",
        subCategory1: "Hydrant Flow Testing",
